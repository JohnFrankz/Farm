...
public class GameConfig {
    ...
    /** 作物种子状态的code */
    public static final int __CROP_SEED_STATUS_CODE = 1;
    /** 作物生长状态的code */
    public static final int __CROP_GROWTH_STATUS_CODE = 2;
    /** 作物成熟状态的code */
    public static final int __CROP_MATURITY_STATUS_CODE = 3;
    /** 作物枯草状态的code */
    public static final int __CROP_DRY_STATUS_CODE = 4;

    /** 作物种子阶段的code */
    public static final int __CROP_SEED_STAGE_CODE = 0;
    /** 作物生长阶段的code */
    public static final int __CROP_GROWTH_STAGE_CODE = 1;
    /** 作物开花阶段的code */
    public static final int __CROP_FLOWERING_STAGE_CODE = 4;
    /** 作物成熟阶段的code */
    public static final int __CROP_MATURITY_STAGE_CODE = 5;
    /** 作物枯草阶段的code */
    public static final int __CROP_DRY_STAGE_CODE = 6;
